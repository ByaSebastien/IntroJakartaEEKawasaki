...
<head>
    ...
    <title>Connexion - Kawasaki</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="form-card">
            <h1>⚡ CONNEXION</h1>
            <p class="subtitle">Kawasaki Performance</p>
            ...
            <div class="form-footer">
                <p>Pas encore membre ? <a href="${pageContext.request.contextPath}/auth/register">S'inscrire ici</a></p>
            </div>
        </div>
    </div>
